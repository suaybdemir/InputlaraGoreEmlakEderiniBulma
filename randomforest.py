...
# Random Forest Regressor modeli oluşturun
...
print("Ortalama Kare Hatası (MSE):", mean_squared_error(y_test, y_pred_rf))
...
plt.title("Random Forest - Gerçek vs Tahmin Edilen Fiyatlar")
